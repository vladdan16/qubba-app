            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    l10n.cabinetsError(error.toString()),
                ...
                ? Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 16),
                        Text(l10n.cabinetsEmpty),
                        const SizedBox(height: 16),
                        ElevatedButton.icon(
                          onPressed: () => context.openCabinetAdd(),
                          icon: const Icon(Icons.add),
                          label: Text(l10n.cabinetsAddCabinet),
                        ),
                      ],
                    ),
                  )
...
class _CabinetCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final l10n = Strings.of(context);
    final isActive = cabinet.isActive ?? true;
