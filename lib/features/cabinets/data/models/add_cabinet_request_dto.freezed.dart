...
mixin _$AddCabinetRequestDto {
 ...
 String get name;@JsonKey(name: 'legal_type') int get legalType;@JsonKey(name: 'tax_type') int get taxType;@JsonKey(name: 'tax_rate') int get taxRate;@JsonKey(name: 'nds_rate') int get ndsRate;@JsonKey(name: 'tax_type_2024') int get taxType2024;@JsonKey(name: 'tax_rate_2024') int get taxRate2024;@JsonKey(name: 'organization_name') String? get organizationName;@JsonKey(name: 'organization_inn') String? get organizationInn;@JsonKey(name: 'unit_maintenance_cost') int? get unitMaintenanceCost;@JsonKey(name: 'is_active') bool get isActive;@JsonKey(name: 'wb_api_key') String? get wbApiKey;@JsonKey(name: 'wb_api_active') bool get wbApiActive;@JsonKey(name: 'ozon_client_id') String? get ozonClientId;@JsonKey(name: 'ozon_api_key') String? get ozonApiKey;@JsonKey(name: 'ozon_performance_client_id') String? get ozonPerformanceClientId;@JsonKey(name: 'ozon_performance_client_secret') String? get ozonPerformanceClientSecret;@JsonKey(name: 'ozon_api_active') bool get ozonApiActive;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,legalType,taxType,taxRate,ndsRate,taxType2024,taxRate2024,organizationName,organizationInn,unitMaintenanceCost,isActive,wbApiKey,wbApiActive,ozonClientId,ozonApiKey,ozonPerformanceClientId,ozonPerformanceClientSecret,ozonApiActive);

@override
String toString() {
  return 'AddCabinetRequestDto(name: $name, legalType: $legalType, taxType: $taxType, taxRate: $taxRate, ndsRate: $ndsRate, taxType2024: $taxType2024, taxRate2024: $taxRate2024, organizationName: $organizationName, organizationInn: $organizationInn, unitMaintenanceCost: $unitMaintenanceCost, isActive: $isActive, wbApiKey: $wbApiKey, wbApiActive: $wbApiActive, ozonClientId: $ozonClientId, ozonApiKey: $ozonApiKey, ozonPerformanceClientId: $ozonPerformanceClientId, ozonPerformanceClientSecret: $ozonPerformanceClientSecret, ozonApiActive: $ozonApiActive)';
}
...
/// Create a copy of AddCabinetRequestDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? legalType = null,Object? taxType = null,Object? taxRate = null,Object? ndsRate = null,Object? taxType2024 = null,Object? taxRate2024 = null,Object? organizationName = freezed,Object? organizationInn = freezed,Object? unitMaintenanceCost = freezed,Object? isActive = null,Object? wbApiKey = freezed,Object? wbApiActive = null,Object? ozonClientId = freezed,Object? ozonApiKey = freezed,Object? ozonPerformanceClientId = freezed,Object? ozonPerformanceClientSecret = freezed,Object? ozonApiActive = null,}) {
...
as String?,unitMaintenanceCost: freezed == unitMaintenanceCost ? _self.unitMaintenanceCost : unitMaintenanceCost // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name, @JsonKey(name: 'legal_type')  int legalType, @JsonKey(name: 'tax_type')  int taxType, @JsonKey(name: 'tax_rate')  int taxRate, @JsonKey(name: 'nds_rate')  int ndsRate, @JsonKey(name: 'tax_type_2024')  int taxType2024, @JsonKey(name: 'tax_rate_2024')  int taxRate2024, @JsonKey(name: 'organization_name')  String? organizationName, @JsonKey(name: 'organization_inn')  String? organizationInn, @JsonKey(name: 'unit_maintenance_cost')  int? unitMaintenanceCost, @JsonKey(name: 'is_active')  bool isActive, @JsonKey(name: 'wb_api_key')  String? wbApiKey, @JsonKey(name: 'wb_api_active')  bool wbApiActive, @JsonKey(name: 'ozon_client_id')  String? ozonClientId, @JsonKey(name: 'ozon_api_key')  String? ozonApiKey, @JsonKey(name: 'ozon_performance_client_id')  String? ozonPerformanceClientId, @JsonKey(name: 'ozon_performance_client_secret')  String? ozonPerformanceClientSecret, @JsonKey(name: 'ozon_api_active')  bool ozonApiActive)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AddCabinetRequestDto() when $default != null:
return $default(_that.name,_that.legalType,_that.taxType,_that.taxRate,_that.ndsRate,_that.taxType2024,_that.taxRate2024,_that.organizationName,_that.organizationInn,_that.unitMaintenanceCost,_that.isActive,_that.wbApiKey,_that.wbApiActive,_that.ozonClientId,_that.ozonApiKey,_that.ozonPerformanceClientId,_that.ozonPerformanceClientSecret,_that.ozonApiActive);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name, @JsonKey(name: 'legal_type')  int legalType, @JsonKey(name: 'tax_type')  int taxType, @JsonKey(name: 'tax_rate')  int taxRate, @JsonKey(name: 'nds_rate')  int ndsRate, @JsonKey(name: 'tax_type_2024')  int taxType2024, @JsonKey(name: 'tax_rate_2024')  int taxRate2024, @JsonKey(name: 'organization_name')  String? organizationName, @JsonKey(name: 'organization_inn')  String? organizationInn, @JsonKey(name: 'unit_maintenance_cost')  int? unitMaintenanceCost, @JsonKey(name: 'is_active')  bool isActive, @JsonKey(name: 'wb_api_key')  String? wbApiKey, @JsonKey(name: 'wb_api_active')  bool wbApiActive, @JsonKey(name: 'ozon_client_id')  String? ozonClientId, @JsonKey(name: 'ozon_api_key')  String? ozonApiKey, @JsonKey(name: 'ozon_performance_client_id')  String? ozonPerformanceClientId, @JsonKey(name: 'ozon_performance_client_secret')  String? ozonPerformanceClientSecret, @JsonKey(name: 'ozon_api_active')  bool ozonApiActive)  $default,) {final _that = this;
switch (_that) {
case _AddCabinetRequestDto():
return $default(_that.name,_that.legalType,_that.taxType,_that.taxRate,_that.ndsRate,_that.taxType2024,_that.taxRate2024,_that.organizationName,_that.organizationInn,_that.unitMaintenanceCost,_that.isActive,_that.wbApiKey,_that.wbApiActive,_that.ozonClientId,_that.ozonApiKey,_that.ozonPerformanceClientId,_that.ozonPerformanceClientSecret,_that.ozonApiActive);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name, @JsonKey(name: 'legal_type')  int legalType, @JsonKey(name: 'tax_type')  int taxType, @JsonKey(name: 'tax_rate')  int taxRate, @JsonKey(name: 'nds_rate')  int ndsRate, @JsonKey(name: 'tax_type_2024')  int taxType2024, @JsonKey(name: 'tax_rate_2024')  int taxRate2024, @JsonKey(name: 'organization_name')  String? organizationName, @JsonKey(name: 'organization_inn')  String? organizationInn, @JsonKey(name: 'unit_maintenance_cost')  int? unitMaintenanceCost, @JsonKey(name: 'is_active')  bool isActive, @JsonKey(name: 'wb_api_key')  String? wbApiKey, @JsonKey(name: 'wb_api_active')  bool wbApiActive, @JsonKey(name: 'ozon_client_id')  String? ozonClientId, @JsonKey(name: 'ozon_api_key')  String? ozonApiKey, @JsonKey(name: 'ozon_performance_client_id')  String? ozonPerformanceClientId, @JsonKey(name: 'ozon_performance_client_secret')  String? ozonPerformanceClientSecret, @JsonKey(name: 'ozon_api_active')  bool ozonApiActive)?  $default,) {final _that = this;
switch (_that) {
case _AddCabinetRequestDto() when $default != null:
return $default(_that.name,_that.legalType,_that.taxType,_that.taxRate,_that.ndsRate,_that.taxType2024,_that.taxRate2024,_that.organizationName,_that.organizationInn,_that.unitMaintenanceCost,_that.isActive,_that.wbApiKey,_that.wbApiActive,_that.ozonClientId,_that.ozonApiKey,_that.ozonPerformanceClientId,_that.ozonPerformanceClientSecret,_that.ozonApiActive);case _:
  return null;
...
class _AddCabinetRequestDto implements AddCabinetRequestDto {
  const _AddCabinetRequestDto({required this.name, @JsonKey(name: 'legal_type') required this.legalType, @JsonKey(name: 'tax_type') required this.taxType, @JsonKey(name: 'tax_rate') required this.taxRate, @JsonKey(name: 'nds_rate') required this.ndsRate, @JsonKey(name: 'tax_type_2024') required this.taxType2024, @JsonKey(name: 'tax_rate_2024') required this.taxRate2024, @JsonKey(name: 'organization_name') this.organizationName, @JsonKey(name: 'organization_inn') this.organizationInn, @JsonKey(name: 'unit_maintenance_cost') this.unitMaintenanceCost, @JsonKey(name: 'is_active') this.isActive = true, @JsonKey(name: 'wb_api_key') this.wbApiKey, @JsonKey(name: 'wb_api_active') this.wbApiActive = false, @JsonKey(name: 'ozon_client_id') this.ozonClientId, @JsonKey(name: 'ozon_api_key') this.ozonApiKey, @JsonKey(name: 'ozon_performance_client_id') this.ozonPerformanceClientId, @JsonKey(name: 'ozon_performance_client_secret') this.ozonPerformanceClientSecret, @JsonKey(name: 'ozon_api_active') this.ozonApiActive = false});
...
/// Create a copy of AddCabinetRequestDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? legalType = null,Object? taxType = null,Object? taxRate = null,Object? ndsRate = null,Object? taxType2024 = null,Object? taxRate2024 = null,Object? organizationName = freezed,Object? organizationInn = freezed,Object? unitMaintenanceCost = freezed,Object? isActive = null,Object? wbApiKey = freezed,Object? wbApiActive = null,Object? ozonClientId = freezed,Object? ozonApiKey = freezed,Object? ozonPerformanceClientId = freezed,Object? ozonPerformanceClientSecret = freezed,Object? ozonApiActive = null,}) {
