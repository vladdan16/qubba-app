...
@override@JsonKey(name: 'employees') List<EmployeeDto> get employees {
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,organizationName,organizationInn,legalType,taxType,taxRate,ndsRate,taxType2024,taxRate2024,unitMaintenanceCost,isActive,wbApiKey,wbApiActive,ozonClientId,ozonApiKey,ozonPerformanceClientId,ozonPerformanceClientSecret,ozonApiActive,createdAt,updatedAt,const DeepCollectionEquality().hash(_employees)]);
